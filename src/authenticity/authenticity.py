...
class AuthenticityInfoBox(customtkinter.CTkFrame):
    def __init__(self, master):
        ...
        # Type Entry
        self.label_type_entry = customtkinter.CTkEntry(self, width=400)
        ...
        # Muscle Entry
        self.label_muscle_entry = customtkinter.CTkEntry(self, width=400)
        ...
        # Equipment Entry
        self.label_equip_entry = customtkinter.CTkEntry(self, width=400)
        ...
        # Difficulty Entry
        self.label_difficulty_entry = customtkinter.CTkEntry(self, width=400)
        ...
        # Infobox Textbox
        self.textbox_infobox = customtkinter.CTkTextbox(self, width=400)
...
class Authenticity(customtkinter.CTk):
    def __init__(self):
        ...
        exercises_by_muscle_list = db.get_exercises()
        ...
        self.exercise_selector_optionemenu.grid(row=3, column=0, padx=20, pady=20)

        self.info_frame = AuthenticityInfoBox(self.selector_frame)
        self.info_frame.grid(row=0, column=1, rowspan=4, padx=10, pady=10)
